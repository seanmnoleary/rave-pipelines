...
loader_sync2 <- ravedash::presets_loader_sync_project_subject(id = "loader_sync_from_recent_project_subject")


# Register the components
component_container$add_components(
  loader_project, loader_subject, loader_sync1, loader_sync2
)
