...
...targets <- list(`__Check_settings_file` = targets::tar_target_raw("settings_path", 
    ...
    input_force_import = targets::tar_target_raw("force_import", 
        ...
        command = quote({
            ...
            "import_blocks__format", "skip_validation")), deps = c("import_blocks__session_block", 
        "subject", "import_channels__electrodes", "import_channels__sample_rate", 
        ...
        command = quote({
            ...
            "import_channels__unit", "force_import")), deps = c("validation_result", 
        "subject", "import_blocks__session_block", "import_channels__electrodes", 
        "import_channels__sample_rate", "import_blocks__format", 
        "import_channels__unit", "force_import"), cue = targets::tar_cue("always"), 
