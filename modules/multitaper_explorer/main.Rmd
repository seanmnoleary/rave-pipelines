...
### Step 5: get heatmap data from multitaper result for frequency data collapsed over time
...
#### Step 6: make machine learning predictions
...
#### Step 8: Visualize Heatmaps for all the generated spectral ranges for a specific condition
...
#### Step 9: Visualize Line Plot for all the generated spectral ranges for a specific condition
...
#### Step 10: Visualize Line Plot for power over frequency for a specific condition
...
#### Step 11: Visualize Quantile Plot for all the generated spectral ranges for a specific condition
...
#### Step 12: Save file for 3D brain display for each spectral result
